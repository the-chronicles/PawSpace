...
// import { View, Text, StyleSheet, Image, TouchableOpacity, FlatList, Alert, ActivityIndicator, ScrollView } from 'react-native';
// import { useRouter } from 'expo-router';
// import { LogOut, Settings, CreditCard as Edit, Package, MessageCircle } from 'lucide-react-native';
...
//         <Image 
//           source={{ 
//             uri: profile?.photoURL || 'https://images.pexels.com/photos/3198013/pexels-photo-3198013.jpeg'
//           }} 
//           style={styles.profileImage}
//         />
//         <View style={styles.profileInfo}>
//           <Text style={styles.profileName}>{profile?.displayName || user?.displayName || 'User'}</Text>
...
//         >
//           <Package size={20} color={activeTab === 'listings' ? '#5FD4C3' : '#666'} />
...
//         >
//           <MessageCircle size={20} color={activeTab === 'posts' ? '#5FD4C3' : '#666'} />
...
//       ) : (
//         <View style={styles.emptyContainer}>
//           <Text style={styles.emptyText}>You don't have any forum posts yet.</Text>
//           <TouchableOpacity 
//             style={styles.createButton}
...
import { View, Text, StyleSheet, Image, TouchableOpacity, FlatList, Alert, ActivityIndicator, ScrollView } from 'react-native';
import { useRouter } from 'expo-router';
import { LogOut, Settings, CreditCard as Edit, Package, MessageCircle, CreditCard } from 'lucide-react-native';
import { useAuth } from '@/hooks/useAuth';
import { getUserListings } from '@/services/listingService';
import { getUserProfile } from '@/services/userService';
import { ListingItem, UserProfile } from '@/types';
      ...
      <View style={styles.profileSection}>
        ...
        <View style={styles.profileInfo}>
          ...
          {profile?.isSeller ? null : (
            <TouchableOpacity style={styles.becomeSellerButton} onPress={handleBecomeSeller}>
            ...
            <TouchableOpacity 
              ...
              onPress={() => {
                if (profile?.isSeller) {
                  ...
                  Alert.alert('Become a Seller', 'You need to complete seller onboarding before listing items.', [
                    { text: 'Cancel', style: 'cancel' },
